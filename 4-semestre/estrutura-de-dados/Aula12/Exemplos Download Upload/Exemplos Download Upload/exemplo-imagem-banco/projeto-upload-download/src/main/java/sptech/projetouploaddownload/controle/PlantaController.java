...
public class PlantaController {
    ...
    public ResponseEntity<Void> patchFoto(@PathVariable int idPlanta, @RequestBody byte[] novaFoto) {
    ...
    // uma lista dos tipos de mime-type está em https://mimetype.io/all-types/ ou em https://www.sitepoint.com/mime-types-complete-list/
    @GetMapping(value = "/relatorio/{idPlanta}", produces = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
