...
//    @ParameterizedTest
 ...
 /*@CsvSource(value =
    ...
    @Test
    fun `Exception quando o preço é negativo`(){
        val vendaNegativo = -0.01
        val vendaNegativo2 = -100.0

        assertThrows(IllegalArgumentException::class.java){
            service.calcularPrecoVenda(vendaNegativo)
        }
       ...
       val excecao = assertThrows(IllegalArgumentException::class.java){
        ...
        assertEquals("Preço da compra não pode ser negativo", excecao.message)
    }
